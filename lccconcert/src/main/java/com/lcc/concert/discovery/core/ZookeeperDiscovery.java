package com.lcc.concert.discovery.core;
...
import com.lcc.concert.common.bean.Session;
import com.lcc.concert.common.bean.Zdata;
import com.lcc.concert.common.cons.ZooKeeperConstant;
import com.lcc.concert.discovery.context.DiscoveryContext;
...
public abstract class ZookeeperDiscovery {
	...
	private void watchNode(final CuratorFramework zkClient) {
		...
		try {
			...
			List<Zdata> nodes = new ArrayList<Zdata>();
