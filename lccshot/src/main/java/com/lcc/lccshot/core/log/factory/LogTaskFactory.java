package com.lcc.lccshot.core.log.factory;

import com.lcc.lccshot.core.constant.state.LogSucceed;
import com.lcc.lccshot.core.constant.state.LogType;
...
public class LogTaskFactory {
    ...
    private static LoginLogRepository loginLogMapper = Db.getMapper(LoginLogRepository.class);
    private static OperationLogRepository operationLogMapper = Db.getMapper(OperationLogRepository.class);
