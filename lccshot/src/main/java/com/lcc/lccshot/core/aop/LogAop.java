package com.lcc.lccshot.core.aop;
...
import com.lcc.lccshot.core.dictmap.factory.DictMapFactory;
...
public class LogAop {
    ...
    @Pointcut(value = "@annotation(com.lcc.lccshot.core.annotion.log.BussinessLog)")
