package com.lcc.lccshot.core.shiro.factory;
...
public class ShiroFactroy implements IShiro {
    ...
    @Autowired
    private UserRepository userMgrDao;
    ...
    public User user(String account) {
        ...
        User user = userMgrDao.findByAccount(account);
    ...
    public String findRoleNameByRoleId(Integer roleId) {
        return LogicConstantFactory.me().getSingleRoleTip(roleId);
    }
