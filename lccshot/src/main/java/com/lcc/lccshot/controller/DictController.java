...
public class DictController extends BaseController {
    ...
    public String deptUpdate(@PathVariable Integer dictId, Model model) {
        ...
        List<Dict> subDicts = dictDao.findByPid(dictId);
     ...
     */
    @BussinessLog(value = "添加字典记录", key = "dictName,dictValues", dict = com.lcc.lccshot.core.constant.Dict.DictMap)
     ...
     * 修改字典
     */
    @BussinessLog(value = "修改字典", key = "dictName,dictValues", dict = com.lcc.lccshot.core.constant.Dict.DictMap)
     ...
     * 删除字典记录
     */
    @BussinessLog(value = "删除字典记录", key = "dictId", dict = com.lcc.lccshot.core.constant.Dict.DeleteDict)
    ...
    public Object delete(@RequestParam Integer dictId) {
        ...
        //缓存被删除的名称
        LogObjectHolder.me().set(LogicConstantFactory.me().getDictName(dictId));
