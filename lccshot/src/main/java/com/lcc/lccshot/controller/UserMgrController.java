...
import com.lcc.lccshot.base.warpper.UserWarpper;
...
import com.lcc.lccshot.controller.dto.UserDto;
import com.lcc.lccshot.controller.dto.UserFactory;
import com.lcc.lccshot.core.db.Db;
...
public class UserMgrController extends BaseController {
    ...
    public String userEdit(@PathVariable Integer userId, Model model) {
        ...
        model.addAttribute("roleName", LogicConstantFactory.me().getRoleName(user.getRoleid()));
        model.addAttribute("deptName", LogicConstantFactory.me().getDeptName(user.getDeptid()));
    ...
    public Object changePwd(@RequestParam String oldPwd, @RequestParam String newPwd, @RequestParam String rePwd) {
        ...
        if (user.getPassword().equals(oldMd5)) {
           ...
           // user.setPassword(newMd5);
            userDao.updatePassById(newMd5,userId);
            return SUCCESS_TIP;
        } else {
    ...
    public Object list(@RequestParam(required = false) String name, @RequestParam(required = false) String beginTime, @RequestParam(required = false) String endTime, @RequestParam(required = false) Integer deptid) {
    	// List<User> users = userDao.selectUsers(name, beginTime, endTime, deptid);
    	List<User> users = userService.selectUsers(name, beginTime, endTime, deptid);
        return new UserWarpper(users,User.class).warp();
    }
    ...
    public Tip add(@Valid UserDto user, BindingResult result) {
        ...
        this.userDao.save(UserFactory.createUser(user));
        return SUCCESS_TIP;
    }
    ...
    public Tip delete(@RequestParam Integer userId) {
        ...
        this.userDao.updateStatusById(userId, ManagerStatus.DELETED.getCode());
        return SUCCESS_TIP;
    }
    ...
    public Tip freeze(@RequestParam Integer userId) {
        ...
        userDao.updateStatusById(userId,ManagerStatus.FREEZED.getCode());
        return SUCCESS_TIP;
    }
    ...
    public Tip unfreeze(@RequestParam Integer userId) {
        ...
        userDao.updateStatusById(userId, ManagerStatus.OK.getCode());
        return SUCCESS_TIP;
    }
    ...
    public Tip setRole(@RequestParam("userId") Integer userId, @RequestParam("roleIds") String roleIds) {
        ...
        userDao.updateRolesById(userId, roleIds);
        return SUCCESS_TIP;
    }
    ...
    public String upload(@RequestPart("file") MultipartFile picture) {
        ...
        try {
            String fileSavePath = baseProperties.getFileUploadPath();
