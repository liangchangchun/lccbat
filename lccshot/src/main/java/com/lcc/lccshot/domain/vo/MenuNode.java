...
public class MenuNode implements Comparable,Serializable {
	...
	private static final long serialVersionUID = 1231860999675294141L;
    ...
    public MenuNode(MenuView view){
    	this.id = Integer.parseInt(view.getI1());
    	this.icon = view.getI2();
    	this.parentId = Integer.parseInt(view.getI3());
    	this.name = view.getI4();
    	this.url = view.getI5();
    	this.levels = Integer.parseInt(view.getI6());
    	this.ismenu = Integer.parseInt(view.getI7());
    	this.num = Integer.parseInt(view.getI8());
    }
    ...
    public MenuNode(Integer id,String icon,Integer parentId,String name,String url,Integer levels,Integer ismenu,Integer num) {
        super();
        this.id = id;
        this.icon = icon;
        this.parentId = parentId;
